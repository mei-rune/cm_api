...
type ApiYarnApplication struct {
	...
	AllocatedVCores float64 `json:"allocatedVCores,omitempty"`
	// The number of containers currently running for the application Available since v12.
	RunningContainers float64 `json:"runningContainers,omitempty"`
	...
	AllocatedMemorySeconds float64 `json:"allocatedMemorySeconds,omitempty"`
	// Allocated vcore-secs to the application. Available since v12.
	AllocatedVcoreSeconds float64 `json:"allocatedVcoreSeconds,omitempty"`
	// The application id.
	...
	ContainerUsedMemorySeconds float64 `json:"containerUsedMemorySeconds,omitempty"`
	...
	ContainerUsedMemoryMax float64 `json:"containerUsedMemoryMax,omitempty"`
	...
	ContainerUsedCpuSeconds float64 `json:"containerUsedCpuSeconds,omitempty"`
	...
	ContainerUsedVcoreSeconds float64 `json:"containerUsedVcoreSeconds,omitempty"`
	...
	ContainerAllocatedMemorySeconds float64 `json:"containerAllocatedMemorySeconds,omitempty"`
	...
	ContainerAllocatedVcoreSeconds float64 `json:"containerAllocatedVcoreSeconds,omitempty"`
}
