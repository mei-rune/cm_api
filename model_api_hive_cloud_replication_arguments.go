...
type ApiHiveCloudReplicationArguments struct {
	...
	CloudRootPath      string             `json:"cloudRootPath,omitempty"`
	ReplicationOption  *ReplicationOption `json:"replicationOption,omitempty"`
}
