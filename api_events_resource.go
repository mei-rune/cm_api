 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *EventsResourceApiReadEventsOpts - Optional Parameters:
...
type EventsResourceApiReadEventsOpts struct {
	MaxResults   optional.Int32
	Query        optional.String
	ResultOffset optional.Int32
}

func (a *EventsResourceApiService) ReadEvents(ctx context.Context, localVarOptionals *EventsResourceApiReadEventsOpts) (ApiEventQueryResult, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
