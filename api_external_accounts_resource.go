 ...
 * @param optional nil or *ExternalAccountsResourceApiCreateAccountOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApiExternalAccount) -
@return ApiExternalAccount
*/

type ExternalAccountsResourceApiCreateAccountOpts struct {
	Body optional.Interface
}

func (a *ExternalAccountsResourceApiService) CreateAccount(ctx context.Context, localVarOptionals *ExternalAccountsResourceApiCreateAccountOpts) (ApiExternalAccount, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name
 * @param optional nil or *ExternalAccountsResourceApiReadAccountOpts - Optional Parameters:
     * @param "View" (optional.String) -
@return ApiExternalAccount
*/

type ExternalAccountsResourceApiReadAccountOpts struct {
	View optional.String
}

func (a *ExternalAccountsResourceApiService) ReadAccount(ctx context.Context, name string, localVarOptionals *ExternalAccountsResourceApiReadAccountOpts) (ApiExternalAccount, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param displayName
 * @param optional nil or *ExternalAccountsResourceApiReadAccountByDisplayNameOpts - Optional Parameters:
     * @param "View" (optional.String) -
@return ApiExternalAccount
*/

type ExternalAccountsResourceApiReadAccountByDisplayNameOpts struct {
	View optional.String
}

func (a *ExternalAccountsResourceApiService) ReadAccountByDisplayName(ctx context.Context, displayName string, localVarOptionals *ExternalAccountsResourceApiReadAccountByDisplayNameOpts) (ApiExternalAccount, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param typeName
 * @param optional nil or *ExternalAccountsResourceApiReadAccountsOpts - Optional Parameters:
     * @param "View" (optional.String) -
@return ApiExternalAccountList
*/

type ExternalAccountsResourceApiReadAccountsOpts struct {
	View optional.String
}

func (a *ExternalAccountsResourceApiService) ReadAccounts(ctx context.Context, typeName string, localVarOptionals *ExternalAccountsResourceApiReadAccountsOpts) (ApiExternalAccountList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name The external account name
 * @param optional nil or *ExternalAccountsResourceApiReadConfigOpts - Optional Parameters:
     * @param "View" (optional.String) -  The view to materialize, either \&quot;summary\&quot; or \&quot;full\&quot;.
@return ApiConfigList
*/

type ExternalAccountsResourceApiReadConfigOpts struct {
	View optional.String
}

func (a *ExternalAccountsResourceApiService) ReadConfig(ctx context.Context, name string, localVarOptionals *ExternalAccountsResourceApiReadConfigOpts) (ApiConfigList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExternalAccountsResourceApiUpdateAccountOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApiExternalAccount) -
@return ApiExternalAccount
*/

type ExternalAccountsResourceApiUpdateAccountOpts struct {
	Body optional.Interface
}

func (a *ExternalAccountsResourceApiService) UpdateAccount(ctx context.Context, localVarOptionals *ExternalAccountsResourceApiUpdateAccountOpts) (ApiExternalAccount, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name The external account name
 * @param optional nil or *ExternalAccountsResourceApiUpdateConfigOpts - Optional Parameters:
...
type ExternalAccountsResourceApiUpdateConfigOpts struct {
	Body    optional.Interface
	Message optional.String
}

func (a *ExternalAccountsResourceApiService) UpdateConfig(ctx context.Context, name string, localVarOptionals *ExternalAccountsResourceApiUpdateConfigOpts) (ApiConfigList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
