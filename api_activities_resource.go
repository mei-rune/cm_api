 ...
 * @param optional nil or *ActivitiesResourceApiGetMetricsOpts - Optional Parameters:
...
type ActivitiesResourceApiGetMetricsOpts struct {
...
func (a *ActivitiesResourceApiService) GetMetrics(ctx context.Context, activityId string, clusterName string, serviceName string, localVarOptionals *ActivitiesResourceApiGetMetricsOpts) (ApiMetricList, *http.Response, error) {
	var (
 ...
 * @param clusterName The name of the cluster
 * @param serviceName The name of the service
 * @param optional nil or *ActivitiesResourceApiReadActivitiesOpts - Optional Parameters:
...
type ActivitiesResourceApiReadActivitiesOpts struct {
...
func (a *ActivitiesResourceApiService) ReadActivities(ctx context.Context, clusterName string, serviceName string, localVarOptionals *ActivitiesResourceApiReadActivitiesOpts) (ApiActivityList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param clusterName The name of the cluster
 * @param serviceName The name of the service
 * @param optional nil or *ActivitiesResourceApiReadActivityOpts - Optional Parameters:
     * @param "View" (optional.String) -  The view of the activity to materialize
@return ApiActivity
*/

type ActivitiesResourceApiReadActivityOpts struct {
	View optional.String
}

func (a *ActivitiesResourceApiService) ReadActivity(ctx context.Context, activityId string, clusterName string, serviceName string, localVarOptionals *ActivitiesResourceApiReadActivityOpts) (ApiActivity, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param clusterName The name of the cluster
 * @param serviceName The name of the service
 * @param optional nil or *ActivitiesResourceApiReadChildActivitiesOpts - Optional Parameters:
     * @param "MaxResults" (optional.Int32) -  The maximum number of activities to return.
     * @param "ResultOffset" (optional.Int32) -  Specified the offset of activities to return.
...
type ActivitiesResourceApiReadChildActivitiesOpts struct {
	MaxResults   optional.Int32
	ResultOffset optional.Int32
	View         optional.String
}

func (a *ActivitiesResourceApiService) ReadChildActivities(ctx context.Context, activityId string, clusterName string, serviceName string, localVarOptionals *ActivitiesResourceApiReadChildActivitiesOpts) (ApiActivityList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param clusterName The name of the cluster
 * @param serviceName The name of the service
 * @param optional nil or *ActivitiesResourceApiReadSimilarActivitiesOpts - Optional Parameters:
     * @param "View" (optional.String) -  The view of the activities to materialize
@return ApiActivityList
*/

type ActivitiesResourceApiReadSimilarActivitiesOpts struct {
	View optional.String
}

func (a *ActivitiesResourceApiService) ReadSimilarActivities(ctx context.Context, activityId string, clusterName string, serviceName string, localVarOptionals *ActivitiesResourceApiReadSimilarActivitiesOpts) (ApiActivityList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
