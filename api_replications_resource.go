 ...
 * @param optional nil or *ReplicationsResourceApiCollectDiagnosticDataOpts - Optional Parameters:
...
type ReplicationsResourceApiCollectDiagnosticDataOpts struct {
	Body optional.Interface
	View optional.String
}

func (a *ReplicationsResourceApiService) CollectDiagnosticData(ctx context.Context, clusterName string, scheduleId float64, serviceName string, localVarOptionals *ReplicationsResourceApiCollectDiagnosticDataOpts) (ApiCommand, *http.Response, error) {
	var (
 ...
 * @param clusterName
 * @param serviceName The service name.
 * @param optional nil or *ReplicationsResourceApiCreateSchedulesOpts - Optional Parameters:
...
type ReplicationsResourceApiCreateSchedulesOpts struct {
	Body optional.Interface
}

func (a *ReplicationsResourceApiService) CreateSchedules(ctx context.Context, clusterName string, serviceName string, localVarOptionals *ReplicationsResourceApiCreateSchedulesOpts) (ApiReplicationScheduleList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *ReplicationsResourceApiService) DeleteSchedule(ctx context.Context, clusterName string, scheduleId float64, serviceName string) (ApiReplicationSchedule, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param clusterName
 * @param serviceName The service name.
 * @param optional nil or *ReplicationsResourceApiGetReplicationStateOpts - Optional Parameters:
     * @param "View" (optional.String) -  view to materialize
@return ApiReplicationState
*/

type ReplicationsResourceApiGetReplicationStateOpts struct {
	View optional.String
}

func (a *ReplicationsResourceApiService) GetReplicationState(ctx context.Context, clusterName string, serviceName string, localVarOptionals *ReplicationsResourceApiGetReplicationStateOpts) (ApiReplicationState, *http.Response, error) {
	var (
 ...
 * @param scheduleId Id of an existing replication schedule.
 * @param serviceName The service name.
 * @param optional nil or *ReplicationsResourceApiReadHistoryOpts - Optional Parameters:
...
type ReplicationsResourceApiReadHistoryOpts struct {
	Limit  optional.Int32
	Offset optional.Int32
	View   optional.String
}

func (a *ReplicationsResourceApiService) ReadHistory(ctx context.Context, clusterName string, scheduleId float64, serviceName string, localVarOptionals *ReplicationsResourceApiReadHistoryOpts) (ApiReplicationCommandList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param scheduleId Id of an existing replication schedule.
 * @param serviceName The service name.
 * @param optional nil or *ReplicationsResourceApiReadScheduleOpts - Optional Parameters:
     * @param "View" (optional.String) -  The view to materialize.
@return ApiReplicationSchedule
*/

type ReplicationsResourceApiReadScheduleOpts struct {
	View optional.String
}

func (a *ReplicationsResourceApiService) ReadSchedule(ctx context.Context, clusterName string, serviceName string, scheduleId int64, localVarOptionals *ReplicationsResourceApiReadScheduleOpts) (ApiReplicationSchedule, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param clusterName
 * @param serviceName The service name.
 * @param optional nil or *ReplicationsResourceApiReadSchedulesOpts - Optional Parameters:
     * @param "View" (optional.String) -  provides summary or detailed view, default is summary
@return ApiReplicationScheduleList
*/

type ReplicationsResourceApiReadSchedulesOpts struct {
	View optional.String
}

func (a *ReplicationsResourceApiService) ReadSchedules(ctx context.Context, clusterName string, serviceName string, localVarOptionals *ReplicationsResourceApiReadSchedulesOpts) (ApiReplicationScheduleList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param clusterName
 * @param serviceName The service name.
 * @param optional nil or *ReplicationsResourceApiRunCopyListingOpts - Optional Parameters:
     * @param "Body" (optional.Interface of string) -
@return ApiCommand
*/

type ReplicationsResourceApiRunCopyListingOpts struct {
	Body optional.Interface
}

func (a *ReplicationsResourceApiService) RunCopyListing(ctx context.Context, clusterName string, serviceName string, localVarOptionals *ReplicationsResourceApiRunCopyListingOpts) (ApiCommand, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param scheduleId Id of an existing replication schedule.
 * @param serviceName The service name.
 * @param optional nil or *ReplicationsResourceApiRunScheduleOpts - Optional Parameters:
     * @param "DryRun" (optional.Bool) -  Whether to execute a dry run.
@return ApiCommand
*/

type ReplicationsResourceApiRunScheduleOpts struct {
	DryRun optional.Bool
}

func (a *ReplicationsResourceApiService) RunSchedule(ctx context.Context, clusterName string, scheduleId float64, serviceName string, localVarOptionals *ReplicationsResourceApiRunScheduleOpts) (ApiCommand, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param scheduleId Id of an existing replication schedule.
 * @param serviceName The service name.
 * @param optional nil or *ReplicationsResourceApiUpdateScheduleOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApiReplicationSchedule) -
@return ApiReplicationSchedule
*/

type ReplicationsResourceApiUpdateScheduleOpts struct {
	Body optional.Interface
}

func (a *ReplicationsResourceApiService) UpdateSchedule(ctx context.Context, clusterName string, scheduleId float64, serviceName string, localVarOptionals *ReplicationsResourceApiUpdateScheduleOpts) (ApiReplicationSchedule, *http.Response, error) {
	var (
