 ...
 * @param optional nil or *HostsResourceApiCreateHostsOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApiHostList) -  The list of hosts to create
@return ApiHostList
*/

type HostsResourceApiCreateHostsOpts struct {
	Body optional.Interface
}

func (a *HostsResourceApiService) CreateHosts(ctx context.Context, localVarOptionals *HostsResourceApiCreateHostsOpts) (ApiHostList, *http.Response, error) {
	var (
 ...
 * @param optional nil or *HostsResourceApiGenerateHostCertsOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApiGenerateHostCertsArguments) -
@return ApiCommand
*/

type HostsResourceApiGenerateHostCertsOpts struct {
	Body optional.Interface
}

func (a *HostsResourceApiService) GenerateHostCerts(ctx context.Context, hostId string, localVarOptionals *HostsResourceApiGenerateHostCertsOpts) (ApiCommand, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param optional nil or *HostsResourceApiGetMetricsOpts - Optional Parameters:
...
type HostsResourceApiGetMetricsOpts struct {
...
func (a *HostsResourceApiService) GetMetrics(ctx context.Context, hostId string, localVarOptionals *HostsResourceApiGetMetricsOpts) (ApiMetricList, *http.Response, error) {
	var (
 ...
 * @param optional nil or *HostsResourceApiMigrateRolesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApiMigrateRolesArguments) -  Arguments for the command.
@return ApiCommand
*/

type HostsResourceApiMigrateRolesOpts struct {
	Body optional.Interface
}

func (a *HostsResourceApiService) MigrateRoles(ctx context.Context, hostId string, localVarOptionals *HostsResourceApiMigrateRolesOpts) (ApiCommand, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param optional nil or *HostsResourceApiReadHostOpts - Optional Parameters:
     * @param "View" (optional.String) -  The view to materialize. Defaults to &#x27;full&#x27;.
@return ApiHost
*/

type HostsResourceApiReadHostOpts struct {
	View optional.String
}

func (a *HostsResourceApiService) ReadHost(ctx context.Context, hostId string, localVarOptionals *HostsResourceApiReadHostOpts) (ApiHost, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hostId The ID of the host.
 * @param optional nil or *HostsResourceApiReadHostConfigOpts - Optional Parameters:
     * @param "View" (optional.String) -  The view of the data to materialize, either \&quot;summary\&quot; or \&quot;full\&quot;.
@return ApiConfigList
*/

type HostsResourceApiReadHostConfigOpts struct {
	View optional.String
}

func (a *HostsResourceApiService) ReadHostConfig(ctx context.Context, hostId string, localVarOptionals *HostsResourceApiReadHostConfigOpts) (ApiConfigList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *HostsResourceApiReadHostsOpts - Optional Parameters:
     * @param "View" (optional.String) -  The view to materialize
@return ApiHostList
*/

type HostsResourceApiReadHostsOpts struct {
	View optional.String
}

func (a *HostsResourceApiService) ReadHosts(ctx context.Context, localVarOptionals *HostsResourceApiReadHostsOpts) (ApiHostList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param optional nil or *HostsResourceApiUpdateHostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApiHost) -  The updated host object.
@return ApiHost
*/

type HostsResourceApiUpdateHostOpts struct {
	Body optional.Interface
}

func (a *HostsResourceApiService) UpdateHost(ctx context.Context, hostId string, localVarOptionals *HostsResourceApiUpdateHostOpts) (ApiHost, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hostId The ID of the host.
 * @param optional nil or *HostsResourceApiUpdateHostConfigOpts - Optional Parameters:
...
type HostsResourceApiUpdateHostConfigOpts struct {
	Body    optional.Interface
	Message optional.String
}

func (a *HostsResourceApiService) UpdateHostConfig(ctx context.Context, hostId string, localVarOptionals *HostsResourceApiUpdateHostConfigOpts) (ApiConfigList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
