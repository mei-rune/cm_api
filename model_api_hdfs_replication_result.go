...
type ApiHdfsReplicationResult struct {
	...
	NumFilesDryRun float64 `json:"numFilesDryRun,omitempty"`
	// The number of bytes found to copy.
	NumBytesDryRun float64 `json:"numBytesDryRun,omitempty"`
	// The number of files expected to be copied.
	NumFilesExpected float64 `json:"numFilesExpected,omitempty"`
	// The number of bytes expected to be copied.
	NumBytesExpected float64 `json:"numBytesExpected,omitempty"`
	// The number of files actually copied.
	NumFilesCopied float64 `json:"numFilesCopied,omitempty"`
	// The number of bytes actually copied.
	NumBytesCopied float64 `json:"numBytesCopied,omitempty"`
	// The number of files that were unchanged and thus skipped during copying.
	NumFilesSkipped float64 `json:"numFilesSkipped,omitempty"`
	// The aggregate number of bytes in the skipped files.
	NumBytesSkipped float64 `json:"numBytesSkipped,omitempty"`
	// The number of files deleted since they were present at destination, but missing from source.
	NumFilesDeleted float64 `json:"numFilesDeleted,omitempty"`
	// The number of files for which copy failed.
	NumFilesCopyFailed float64 `json:"numFilesCopyFailed,omitempty"`
	// The aggregate number of bytes in the files for which copy failed.
	NumBytesCopyFailed float64 `json:"numBytesCopyFailed,omitempty"`
