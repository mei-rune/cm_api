 ...
 * @param optional nil or *AuditsResourceApiReadAuditsOpts - Optional Parameters:
...
type AuditsResourceApiReadAuditsOpts struct {
...
func (a *AuditsResourceApiService) ReadAudits(ctx context.Context, localVarOptionals *AuditsResourceApiReadAuditsOpts) (ApiAuditList, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AuditsResourceApiStreamAuditsOpts - Optional Parameters:
...
type AuditsResourceApiStreamAuditsOpts struct {
	EndTime      optional.String
	MaxResults   optional.Int32
	Query        optional.String
	ResultOffset optional.Int32
...
func (a *AuditsResourceApiService) StreamAudits(ctx context.Context, localVarOptionals *AuditsResourceApiStreamAuditsOpts) (*os.File, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
